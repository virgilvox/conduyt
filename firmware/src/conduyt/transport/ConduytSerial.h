...
class ConduytSerial : public ConduytTransport {
public:
    /**
     * @param serial  Reference to HardwareSerial (Serial, Serial1, etc.)
     * @param baud    Baud rate (default 115200)
     */
    ConduytSerial(HardwareSerial &serial, uint32_t baud = 115200)
     ...
     */
    ConduytSerial(Stream &stream, uint32_t baud = 115200)
